...
export class CommandManager {
  ...
  private async runScenario(...args: CommandArguments): Promise<void> {
    ...
    try {
      ...
      if (lineNumber) {
        ...
        this.testExecutor.runFeatureFile({
          filePath,
        });
   ...
   */
  private debugFeature(...args: CommandArguments): void {
    try {
      const [filePath] = args as [string];
   ...
   */
  private runScenarioWithTags(...args: CommandArguments): void {
    try {
