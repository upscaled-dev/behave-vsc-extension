...
suite("TestExecutor Unit Tests", () => {
  ...
  test("Should build behave command correctly", () => {
    ...
    // Test run scenario
    freshTestExecutor.runScenario(options);
  ...
  test("Should build behave command without line number", () => {
    const options: TestExecutionOptions = {
      filePath: "/test/path/test.feature",
      scenarioName: "Test Scenario",
    };
  ...
  test("Should run feature file", () => {
    ...
    freshTestExecutor.runFeatureFile({ filePath });
  ...
  test("Should execute test with output", () => {
    const options: TestExecutionOptions = {
      filePath: "/test/path/test.feature",
      lineNumber: 5,
    };
    ...
    const result = freshTestExecutor.executeTestWithOutput(options);
  ...
  test("Should handle custom working directory", () => {
